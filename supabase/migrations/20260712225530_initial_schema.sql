-- Initial schema: neighborhoods, vendors, per-neighborhood admins,
-- email-based co-admin invites, and the create_neighborhood /
-- handle_new_user_invites bootstrapping functions.
...
-- NOTE: this self-referencing policy (neighborhood_admins policy that
-- queries neighborhood_admins) caused "infinite recursion detected in
-- policy" in practice — fixed in 20260714183000_fix_admin_recursion.sql.
-- Kept here unmodified so this file matches what was actually run.
